var bankList = {
	"common": [
		...
		// 	"icon": "ZhaoShang.png",
		// 	"name": "招商银行",
		// 	"url": "https://res.cc.cmbimg.com/itafront/taf/formapi/index.html#/login3/api3xxfhwt/remote?webAddress=N57FHXM2073F672300HZ&dsid=SBJYBY01",
		// 	"recommends": [],
		// 	"time": "新户刷卡赢好礼",
		...
		// 	"icon": "GuangDa.png",
		// 	"name": "光大银行",
		// 	"url": "https://xyk.cebbank.com/cebmms/apply/ps/ud-card-list.htm?class=wxps&pro_code=FHTG023536PZ0001RYXZ",
		// 	"recommends": [{
		// 		"text": "大额度",
		// 		"color": "#E91E63"
		// 	}],
...

		{
			...
			"icon": "PingAn.png",
			"name": "平安银行",
			"url": "https://c.pingan.com/ca/index?sign=3fae4d15f370b9a83e3d7261e3eaae94&versionNo=R10310&scc=233100817&channel=WX&onlineSQFlag=N&cardCatenaNo=06a01a02a03a04a05&isDisplayRecommend=N&isDisplaySales=N&bt9=ZY&mt=23WJ3100000226&ccp=mk12a3a4a1a9a30",
			"recommends": [{
				"text": "大额度",
				"color": "#a91a63"
			}],
		...
		// 	"icon": "JiaoTong.png",
		// 	"name": "交通银行",
		// 	"url": "https://creditcardapp.bankcomm.com/applynew/front/apply/mgm/account/wechatEntry.html?recomId=20006996&saleCode=761000224&entryRecomId=&trackCode=A012514502018&isNewCardMgm=0&availableDate=07a9c29f67db7b4c2fdcb7ba305cbe37",
		// 	"recommends": [],
		// 	"time": "新户5积分兑好礼",
		// 	"limit": "最红星期五5%返现",
		// 	"tags": [{
