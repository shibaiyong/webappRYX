(function (D) {
    ...
    self.changePage = function () {
      ...
      var p = Number((D.body && D.body.clientWidth || self.Html.offsetWidth) / 360).toFixed(3);
    ...
    self.correctPx = function () {
      ...
      if (!clientWidth || clientWidth > 360) return;
  
      var div = document.createElement('div');
      div.style.width = '1.4rem';
      div.style.height = '0';
      document.body.appendChild(div);
      var ideal = 140 * clientWidth / 360;
      var rmd = (div.clientWidth / ideal);
  
      if (rmd > 1.2 || rmd < 0.8) {
  
        docEl.style.fontSize = 100 * (clientWidth / 360) / rmd + 'px';
